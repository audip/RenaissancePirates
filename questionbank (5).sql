...
--
-- Host: localhost
-- Generation Time: Feb 14, 2014 at 04:29 PM
...
(11, '', '', '"In the normal course of events many men and women are born with remarkable talents&#59; but occasionally, in a way that transcends nature, a single person is marvelously endowed by Heaven with beauty, grace and talent in such abundance that he leaves other men far behind, all his actions seem inspired and indeed everything he does clearly comes from God rather than from human skill. Everyone acknowledged that this was true of Leonardo da Vinci, an artist of outstanding physical beauty, who displayed infinite grace in everything that he did and who cultivated his genius so brilliantly that all problems he studied he solved with ease."\r\n<span class="clue">Who used these words in praise of Leonardo da Vinci?</span>', 'giorgiovasari', 20),
(12, 'img/ques12.jpg', '', ' "God created man in his own image, in the image of God he created him." \r\n  It is fresco painting by Michelangelo,a masterpiece that illustrates the Biblical creation narrative from the Book of Genesis. <span class="clue">Name the painting and its present location.</span>', 'thecreationofadamsistinechapelceiling', 30),
(13, 'img/Chig!Lorenzetto.jpg\r\n', '', 'The Chigi Chapel is the second chapel on the left-hand side of the nave in the Church of Santa Maria del Popolo. It is his only religious building which has been preserved in its near original form. The chapel is a treasure trove o Baroque art and is considered among the most important monuments in the basilica.<span class="clue"> Who is the Architect of Chigi Chapel? (Write his FULL name.)</span>', 'raffaellosanziourbino', 25),
(14, 'img/StPetersBasilica.jpg\r\n', '', 'It generally refers to one exterior side of a building, usually, the front. The word comes from the FRENCH language, literally meaning "frontage" . What is "the word"? ', 'facade', 20),
(15, '', '', 'The first strain which is fully characterized and also the first to be found in a single species is _____________. ', 'typestrain', 50),
(16, 'img/RomaSMariaLoreto(Sangallo).jpg', '', 'He lived and worked in Rome during the greater part of his life, and was much employed by several of the popes. He designed the brick and travertine church of Santa Maria di Loreto. He was succeeded by Michelangelo as the architect of St. Peter''s Basilica.<span class="clue"> Who was he?</span>', 'antoniodasangallotheyounger', 30),
(17, 'img/selfPortrait.jpg', '', 'It''s a selfie of very famous architect, engineer, anatomist, often described as the archetype of the Renaissance man. <span class="clue">Whose selfie is it?</span>', 'leonardodavinci', 25),
...
(19, '', '', 'He was among the first generation of astronomers to be trained with the Theoricae novae and the Epitome. Shortly before 1514 he began to explore a shocking new idea that the Earth revolves around the Sun. He spent the rest of his life attempting a mathematical proof of heliocentrism. <span class="clue">Who was he?</span>', 'nicolauscopernicus', 30),
(20, '', 'Grab an Electrical Engineer', 'The process of arranging the transmission lines, at irregular distances, for maximum efficiency. <span class="clue">What process is this?</span>', 'transposition', 60),
(21, 'img/Plan_of_Imola.jpg', '', 'Leonardo Da Vinci created this accurate plan for him.  Maps were extremely rare at the time and it would have seemed like a new concept. He then hired Leonardo as his chief architect and military engineer. <span class="clue">Name the town and Leonardo''s employer.</span>\r\n', 'imolacesareborgia', 35),
(22, 'img/sodarktheconofman.jpg', 'Decrypt the Anagram', 'An anagram is a type of word play, the result of rearranging the letters of a word or phrase to produce a new word or phrase, using all the original letters exactly once; for example <em>orchestra</em> can be rearranged into <em>carthorse</em>. <span class="clue">"So dark the con of man"</span>', 'madonnaoftherocks', 35),
(23, 'img/Santa_Maria_Novella.jpg', '', 'Born in Genoa (1402&#45;1472), he was an important Humanist theoretician and designer whose book on architecture De re Aedificatoria was to have lasting effect.two of Alberti&#39;s best known buildings are in Florence, the Palazzo Rucellai and at Santa Maria Novella. Two of his best known buildings are in Florence, the Palazzo Rucellai and at Santa Maria Novella. <span class="clue"> Who is he?</span>', 'leonbattistaalberti', 35),
(24, 'img/renaissancemovie.jpg', '', '<span class="clue">Name the director of the movie Renaissance(2006).</span>', 'christianvolckman', 35),
(25, 'img/ritlaw.jpg', '', 'This law states that work required in crushing is proportional to the new surface created. In other words, crushing efficiency is constant and for a given machine and feed material is independent of the sizes of feed and product. \r\n<span class="clue"> P/ ? = Kr(1/Dsb &#45; 1/Dsa). </span>\r\nWhich law is this?', 'rittingerslaw', 30),
(26, 'img/Constantinople_1453.jpg', '	', 'This historic event marked the end of the Roman Empire, an imperial state which had lasted for nearly 1,500 years. This Ottoman conquest also dealt a massive blow to Christendom. It is considered ,by many scholars, a key to the revival of Greek and Roman studies that led to the development of the Renaissance humanism and science. <span class="clue"> Which event was it? </span>', 'fallofconstantinople', 40),
(27, '', 'Decrypt the Anagram	', 'An anagram is a type of word play, the result of rearranging the letters of a word or phrase to produce a new word or phrase, using all the original letters exactly once; for example <em>orchestra</em> can be rearranged into <em>carthorse</em>. <span class="clue">"I am a weakish speller"</span>\r\n', 'williamshakespeare', 35),
(28, 'img/domeFlorence.jpg', '', 'He was one of the foremost architects and engineers of the Italian Renaissance. He is most famous for his development of linear perspective and for engineering the dome of the Florence Cathedral.	<span class="clue"> Who was he?</span>', 'filippobrunelleschi', 40),
(29, 'img/Statue.jpg', '', 'He was a major Italian poet of the Middle Ages. His Divine Comedy is widely considered the greatest literary work composed in the Italian language and a masterpiece of world literature. <span class="clue"> Who was he? </span>', 'dantealighieri', 35),
(30, 'img/dual-carriageway.jpg', '', '<span class="clue">Technical name of road divider is _________.</span>', 'median', 75);
